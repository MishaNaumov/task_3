...
class Iframe2Page(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.nest_frame_web_element = WebElement(
            self.driver,
            self.NEST_FRAME_WEB_ELEMENT_LOC,
            description="Iframe page -> Iframe web element"
        )
        self.frame_web_element = WebElement(
            self.driver,
            self.FRAME_WEB_ELEMENT_LOC,
            description="Iframe page -> Iframe web element"
        )
        self.title_nest_frame_label = Label(
            self.driver,
            self.TITLE_NEST_FRAME_LABEL_LOC,
            description="Iframe page -> Title label"
        )
        self.title_frame_label = Label(
            self.driver,
            self.TITLE_FRAMES_LABEL_LOC,
            description="Iframe page -> Title label"
        )

        self.page1_iframe1_web_element = WebElement(
            self.driver,
            self.PAGE1_IFRAME1_WEB_ELEMENT_LOC,
            description="Iframe page -> Iframe web element"
        )
        self.page1_iframe2_web_element = WebElement(
            self.driver,
            self.PAGE1_IFRAME2_WEB_ELEMENT_LOC,
            description="Iframe page -> Iframe web element"
        )

        self.page1_iframe1_text_web_element = WebElement(
            self.driver,
            self.PAGE1_IFRAME1_TEXT_WEB_ELEMENT_LOC,
            description="Iframe page -> Iframe web element"
        )
        self.page1_iframe2_text_web_element = WebElement(
            self.driver,
            self.PAGE1_IFRAME2_TEXT_WEB_ELEMENT_LOC,
            description="Iframe page -> Iframe web element"
        )

        self.page2_iframe1_web_element = WebElement(
            self.driver,
            self.PAGE2_IFRAME1_WEB_ELEMENT_LOC,
            description="Iframe page -> Iframe web element"
        )
        self.page2_iframe2_web_element = WebElement(
            self.driver,
            self.PAGE2_IFRAME2_WEB_ELEMENT_LOC,
            description="Iframe page -> Iframe web element"
        )

        self.page2_iframe1_text_web_element = WebElement(
            self.driver,
            self.PAGE2_IFRAME1_TEXT_WEB_ELEMENT_LOC,
            description="Iframe page -> Iframe web element"
        )
        self.page2_iframe2_text_web_element = WebElement(
            self.driver,
